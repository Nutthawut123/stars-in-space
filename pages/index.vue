<template lang="html">
  <div>
    ...
    <div>
      <v-text-field v-model="DayID" type="text" label="Day" color="#ffffff" />
      <v-text-field v-model="MonthID" type="text" label="Month" color="#ffffff" />
      <v-text-field v-model="YearID" type="text" label="Year" color="#ffffff" />
      <v-btn color="#E53935" @click="nanaha">
        Search
      </v-btn>
      </v-date-picker>
    </div>
